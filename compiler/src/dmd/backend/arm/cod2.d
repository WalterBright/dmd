...
void cdorth(ref CGstate cg, ref CodeBuilder cdb,elem *e,regm_t *pretregs)
{
    ...
    switch (e.Eoper)
    {
        ...
        {
            uint sf = sz == 8;
            uint opc = e.Eoper == OPand ? 0 : e.Eoper == OPor ? 1 : 2;
...
void cdcom(ref CGstate cg, ref CodeBuilder cdb,elem *e,regm_t *pretregs)
{
    ...
    /* MVN https://www.scs.stanford.edu/~zyedidia/arm64/mvn_orn_log_shift.html
     */
...
void cdbswap(ref CGstate cg, ref CodeBuilder cdb,elem *e,regm_t *pretregs)
{
    ...
    /* REV16 https://www.scs.stanford.edu/~zyedidia/arm64/rev16_int.html
     * REV32 https://www.scs.stanford.edu/~zyedidia/arm64/rev32_int.html
     * REV64 https://www.scs.stanford.edu/~zyedidia/arm64/rev64_rev.html
     */
    uint sf = sz >= 4;
    uint S = 0;
    uint opcode2 = 0;
    uint opc = sz == 2 ? 1 : sz == 4 ? 2 : 3;
    uint ins = (sf    << 31) |
               (1     << 30) |
               (S     << 29) |
               (0xD6  << 21) |
